...
public class Event {
	public enum Type {
		COMPRESSION_START, DECOMPRESSION_START, BEFORE_TRANSFORM, AFTER_TRANSFORM, BEFORE_ENTROPY, AFTER_ENTROPY,
		COMPRESSION_END, DECOMPRESSION_END, AFTER_HEADER_DECODING
	}
